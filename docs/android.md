...
오른쪽 끝의 **－** 는 창을 접습니다. 종이도 손잡이도 사라지고 바에는 **＋** 와
**✕** 만 남아 82dp짜리 알약이 됩니다 — 종이가 없는데 투명도와 통과 여부를
물어봐야 소용이 없습니다. 알약은 창의 **오른쪽 끝**, 곧 방금 그 두 단추가 있던
자리에 그대로 섭니다. 두 단추의 화면 좌표가 접기 전후로 같아서 눌린 손가락
밑에서 단추가 달아나지 않습니다. 다른 앱을 잠깐 통째로 봐야 할 때 닫았다 다시 띄우면
